<div class="search-tabs" id="search-tabs-2">
            	<div class="container">
                    <script charset="utf-8" src="//www.travelpayouts.com/widgets/b7e7eb5bfff883a1673dcc110f31e43b.js?v=1801" async></script>
                    ...
                    <div class="row d-none">
                        <div class="col-sm-12">
                            ...
                            <ul class="nav nav-tabs">
                                <li><a href="#flights" data-toggle="tab" class="active"><span><i class="fa fa-plane"></i></span><span class="st-text">Flights</span></a></li>
                                ...
                                <li><a href="#hajj" data-toggle="tab"><span><i class="fa fa-kaaba"></i></span><span class="st-text">Hajj</span></a></li>
                                <li><a href="#umrah" data-toggle="tab"><span><i class="fa fa-kaaba"></i></span><span class="st-text">Umrah</span></a></li>
                            </ul>
