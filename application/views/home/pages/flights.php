                ...
                <div class="filter-page__content">
                    <div class="filter-item-wrapper">
                        ...
                        <div class="flight-item">
                            <div class="item-media">
                                <div class="image-cover">
                                    <img src="<?php echo lang('assets'); ?>images/flight/1.jpg" alt="">
                                </div>
                            </div>
                            <div class="item-body">
                                ...
                                <table class="item-table">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td class="route">
                                                <ul>
                                                    <li>HAN <i class="fas fa-long-arrow-alt-right"></i></li>
                        ...
                        <div class="flight-item">
                            <div class="item-media">
                                <div class="image-cover">
                                    <img src="<?php echo lang('assets'); ?>images/flight/3.jpg" alt="">
                                </div>
                            </div>
                            <div class="item-body">
                                <div class="item-title">
